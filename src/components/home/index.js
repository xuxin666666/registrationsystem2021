...
import iMac from '../../asset/image/iMac.jpg'
    ...
    return (
        <Typography id='home_typography'>
            <Image.PreviewGroup>
                ...
                <Card className='home_image_right_0'>
                    <Image src={room} ></Image>
                    <div>我们的工作室</div>
                </Card>
                <Card className='home_image_left_1'>
                ...
                <Card className='home_image_right_2'>
                    <Image src={refrigerator} ></Image>
                    <div>小冰箱和饮水机</div>
                </Card>
                <Card className='home_image_left_3'>
                    <Image src={iMac} ></Image>
                    <div>大屏的iMAC</div>
                </Card>
                ...
                <Card className='home_image_right_4'>
